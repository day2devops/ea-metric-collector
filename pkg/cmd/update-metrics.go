...
func newUpdateMetricsCmd() (*cobra.Command, *UpdateMetricsCommand) {
	...
	updateMetricsCmd.Flags().StringVar(&umc.baseURL, "baseURL", "https://github.edwardjones.com/", "Override the default base url")
	updateMetricsCmd.Flags().StringVar(&umc.org, "org", "ej", "Override the default organization of repositories")
